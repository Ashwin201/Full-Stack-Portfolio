         ...
         dark:border-white  hover:scale-95 transition-all duration-300 ease-in-out max-[300px]:mr-0 max-[300px]:mb-3"
                      >
                        <Link
                          ...
                          aria-label="Resume"
                          href={`${item?.resume}`}
                          className=" flex items-center  text-center justify-center   py-[6px] px-3 text-sm "
                        >
                          Download CV
                          <span className="ml-2">
                      ...
                      <li
                        className=" border-solid   hover:scale-95  transition-all duration-300 ease-in-out rounded-md font-medium  border-2 border-gray-900
                       dark:border-gray-200 dark:text-gray-200 text-gray-900   "
                      >
                        <Link
                          href="/contact"
                          aria-label="Contact"
                          className="flex items-center justify-center py-[6px]  px-3 text-sm "
                        >
                          Get in Touch
                          <span className="ml-2">
